...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    const InputDecoration emailDecor = InputDecoration(
      ...
      hintText: "...",
      hintStyle: TextStyle(fontFamily: "Rota", color: Colors.grey, fontWeight: FontWeight.w500),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 17.0),
              child: Text("Enter your credentials to get \nquick consultancies from expert doctors"),
            ),
            const Gap(30),
            Padding(
